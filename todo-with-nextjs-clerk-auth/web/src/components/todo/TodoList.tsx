...
export default function TodoList({ status, todos, refetchQuery }: TodoListProps) {
  ...
  return (
    <div className="mx-auto bg-gray-100 dark:bg-slate-800 flex-col h-screen lg:w-1/2 w-full rounded-xl p-2 lg:p-12 border shadow-xl overflow-auto">
      <TransitionGroup
